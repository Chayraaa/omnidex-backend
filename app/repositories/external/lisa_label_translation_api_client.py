...
from app.services.label_translation_errors import (
    InvalidLabelTranslationResponse,
    LabelTranslationUnavailable,
)
...
class LisaLabelTranslationApiClient(LabelTranslationAdapterProtocol):
    ...
    def translate_label(self, prompt: str) -> str:
        if not isinstance(prompt, str) or not prompt.strip():
            raise InvalidLabelTranslationResponse("Label translation prompt must be a non-empty string")
